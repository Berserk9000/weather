function startPage() {
    ...
    // unique API
    var APIKey = "c9171a22ca52ca8877ccb46ef06fe2f9";
    ...
    currentTempEl.innerHTML = "Temperatur: " + k2f(response.data.main.temp) + " &#176F";
    ...
    axios.get(forecastQueryURL)
        .then(function (response) {
            ...
            for (i = 0; i < forecastEls.length; i++) {
                ...
                varforecastTempEl = document.createElement("p");
